...
const FindShelterPage = () => {
  ...
  const sampleShelters = [
    {
      ...
      description:
        '서울시에서 운영하는 공공 동물보호센터로 안전하고 체계적인 입양 서비스를 제공합니다.',
    },
    {
      id: '2',
      name: '사랑의 동물보호소',
      ...
      phone: '031-977-2400',
      position: { lat: 37.657, lng: 126.7706 },
      city: '고양시',
      region: '일산동구',
      type: 'private',
      rating: 4.8,
      ...
      description:
        '개인이 운영하는 민간 보호소로 따뜻한 사랑으로 동물들을 돌보고 있습니다.',
    },
    {
      id: '3',
      name: '경기도 동물보호센터',
      ...
      description:
        '경기도에서 운영하는 대규모 동물보호센터로 전문적인 의료 서비스를 제공합니다.',
    },
    {
      id: '4',
      name: '한국동물구조관리협회',
      ...
      description:
        '동물 구조 및 보호 전문 기관으로 긴급 상황 대응과 전문 치료를 제공합니다.',
    },
    {
      id: '5',
      name: '인천시 동물보호센터',
      ...
      description:
        '인천시에서 운영하는 공공 동물보호센터로 체계적인 보호 서비스를 제공합니다.',
    },
  ];
  ...
  const filteredShelters = sampleShelters
    .filter((shelter) => filterType === 'all' || shelter.type === filterType)
    .filter(
      (shelter) =>
